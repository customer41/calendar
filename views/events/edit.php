...
<div>
    ...
    <?php echo $form->field($event, 'start')->textInput(['value' => Yii::$app->formatter->asDatetime($event->start)]); ?>
    <?php echo $form->field($event, 'finish')->textInput(['value' => Yii::$app->formatter->asDatetime($event->finish)]); ?>
